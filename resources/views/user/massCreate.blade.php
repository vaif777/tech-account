  ...
  <div class="container-fluid">
    ...
    <div>
      ...
      <div class="card card-default">
        ...
        <div class="card-body">
          <div class="form-group">
            <form method="post" action="{{ route('user.mass-store') }}">
              @csrf
              <div class="card-body">
                <div class="form-group">
                  <label for="exampleInputPassword1">Перечислети электронные адреса (писать через запятую
                    обязательно).</label>
                  <textarea class="form-control @error('email') is-invalid @enderror" name="email" rows="3"
                    placeholder="Перечислети электронные адреса">{{ old('email') }}</textarea>
                  <div class="mt-2">
                    @if ($errors->any())
      ...
      <div class="card card-default collapsed-card">
        <div class="card-header">
          <h3 class="card-title">Вы можете добавить для всех пользователей одинаковые права и возможности</h3>
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group clearfix">
                <div class="icheck-secondary d-inline">
                  <input value="1" name="activated_user" type="checkbox" {{ old('activated_user') ? 'checked' : '' }}
